...
lines.push('');
lines.push('/** Fields accepted on the mobile bar config. */');
lines.push(`export const MOBILE_FIELDS = ${arr(fieldsOf('MobileConfig'))} as const;`);
lines.push('');
lines.push('/** Properties a mobile override or use-entry patch may set. */');
lines.push(`export const MOBILE_OVERRIDE_FIELDS = ${arr(fieldsOf('MobileOverride'))} as const;`);
lines.push('');
lines.push('/** Allowed mobile `labels` values. */');
lines.push(`export const MOBILE_LABELS = ${arr(enumOf('MobileLabels'))} as const;`);
lines.push('');

...
const VERBS = [
  'overrode', 'guarded', 'painted', 'drifted', 'anchored', 'braided',
  'carved', 'dimmed', 'echoed', 'folded', 'gathered', 'hummed',
  'jolted', 'kindled', 'looped', 'mended', 'nudged', 'orbited',
  'paced', 'quoted', 'rippled', 'sketched', 'tilted', 'unwound',
  'vaulted', 'wandered', 'yielded', 'zoomed', 'blinked', 'chimed',
  'dozed', 'ferried', 'glowed', 'hopped', 'inked', 'juggled',
  'knotted', 'lifted', 'mirrored', 'nested', 'opened', 'polished',
  'quivered', 'rounded', 'stacked', 'traced', 'ushered', 'varnished',
] as const;

/** Concrete nouns for the second slot. */
const NOUNS_A = [
  'contact', 'lantern', 'harbor', 'meadow', 'copper', 'signal',
  'ledger', 'compass', 'thimble', 'orchard', 'pillar', 'ribbon',
  'saddle', 'tunnel', 'vessel', 'window', 'anchor', 'basket',
  'canyon', 'dial', 'ember', 'fiddle', 'garnet', 'hollow',
  'island', 'jigsaw', 'kettle', 'lattice', 'marble', 'nickel',
  'oyster', 'pebble', 'quarry', 'rocket', 'shutter', 'timber',
  'umbrella', 'violin', 'walnut', 'yarn', 'zephyr', 'beacon',
  'cinder', 'drum', 'easel', 'flint', 'grove', 'hinge',
] as const;

/** Adjectives for the third slot. */
const ADJECTIVES = [
  'beefy', 'amber', 'brisk', 'candid', 'dapper', 'eager',
  'feral', 'gentle', 'hardy', 'ivory', 'jovial', 'keen',
  'limber', 'mellow', 'nimble', 'opal', 'plucky', 'quirky',
  'rustic', 'sturdy', 'tidy', 'umber', 'vivid', 'wiry',
  'young', 'zesty', 'bold', 'crisp', 'dusky', 'earnest',
  'frosty', 'glossy', 'humble', 'iron', 'jaunty', 'kindred',
  'lively', 'minty', 'noble', 'oaken', 'pale', 'quiet',
  'rosy', 'silken', 'tart', 'upbeat', 'velvet', 'warm',
] as const;

/** Closing nouns for the fourth slot. */
const NOUNS_B = [
  'tremble', 'summit', 'thicket', 'current', 'harvest', 'lagoon',
  'monsoon', 'nettle', 'outpost', 'prairie', 'ravine', 'sonnet',
  'trellis', 'upland', 'vortex', 'willow', 'aurora', 'boulder',
  'cascade', 'delta', 'estuary', 'fjord', 'geyser', 'horizon',
  'inlet', 'juniper', 'knoll', 'lichen', 'mesa', 'nimbus',
  'oasis', 'plateau', 'quartz', 'riverbed', 'sequoia', 'tundra',
  'undertow', 'valley', 'wharf', 'yonder', 'zenith', 'bramble',
  'cove', 'dune', 'eddy', 'floe', 'glacier', 'heath',
] as const;
